...
export default function Filler(){
    ...
    const collectionRef = collection(db , "service")
            const q = query(collectionRef, orderBy("timestamp", "desc"),  where('type', '==', 'FILLER'));
    ...
    return(
        <div>
              ...
              <div className=" grid sm:grid-cols-2 md:grid-cols-5 row-1">
                  ...
                  <div className="grid sm:col-span-1 md:col-span-1 ">
                      <div className="flex row  justify-center items-center ">
                          <div>
                      <h1 className="text-nogoon text-4xl ">Филлер</h1>
                      <h1 className=" mt-2 grid text-center">Үйлчилгээ {">"} Филлер</h1>
                      </div>
                      </div>
                  </div>
               </div>
            ...
            <div>
            <h1 className="text-center mt-10 text-2xl font-gentium">Филлер</h1>
                    <div className="grid justify-center mt-">
                         ...
                         <h1 className="font-hurricane text-3xl text-center text-fuchsia">Filler</h1>
