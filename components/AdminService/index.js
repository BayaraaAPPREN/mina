import AdminServiceComp from "../Card/service";
import DialogJob from "../AdminDialogService";
           ...
           <div className="grid md:grid-cols-4 lg:grid-cols-6 mt-10">
            ...
            <div className="grid col-span-4">
                <div className=" mb-8 flex justify-center">
                   <h1 className="inline-block mr-8 ">Үйлчилгээ</h1>
                ...
                <div className="flex justify-center text-center mt-10 mb-20">
                       <div className="">
                        <div className="grid justify-center sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-3 ">
                                        {zar.map(zar => <AdminServiceComp key={zar.id}
                                            id={zar.id}
                                            title={zar.title}
                                            img={zar.img}
